...
const HeroCarousel = ({ heading, message }) => {
  ...
  return (
    <div className="relative flex items-center justify-center h-screen mb-12 bg-cover">
      ...
      <button onClick={prevSlide} className="absolute top-1/2 left-0 transform -translate-y-1/2 text-4xl text-white text-opacity-20 p-2 hover:bg-opacity-75" style="z-index: 100;">
        &#10094;
      </button>
      <button onClick={nextSlide} className="absolute top-1/2 right-0 transform -translate-y-1/2 text-4xl text-white text-opacity-20 p-2 hover:bg-opacity-75" style="z-index: 100;">
        &#10095;
      </button>
